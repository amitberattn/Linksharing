        ...
        <g:if test="${my_subscriptions.size() > 0}">
            <g:if test="${(my_subscriptions.topic.resource.flatten() as List<com.linksharing.Resource>).size() > 0}">
                <g:each in="${(my_subscriptions.topic.resource.flatten() as List<com.linksharing.Resource>)}" status="i"
                        var="resourceItem">
                    <g:if test="${userDetail?.id in (resourceItem.readingItem.userDetail.id as java.util.List<Long>)}">
                                        ...
                                        <span class="entry-date">
                                            ...
                                            <div class="modify">
                                                ...
                                                %{--<a href="/linksharing/images/topic/${resourceItem.fileName}">Download</a>--}%
                                                    <g:link style="cursor: pointer" controller="documentResource"
                                                            action="download" id="${resourceItem.id}">Download</g:link>
                                                </g:else>
                                            </div>
                                        </span>
                                    </div>
                                    ...
                                    <span class="entry-date">
                                        ...
                                        <div class="modify">
                                            ...
                                            <g:if test="${userDetail?.id in ((((resourceItem.readingItem as List).findAll {
                                                ...
                                                <a style="cursor: pointer" id="${resourceItem.id}"
                                                   class="markread">Mark as rrrrrrrrread</a>
                                            </g:if>
                                            <g:else>
                                                <a style="cursor: pointer" id="${resourceItem.id}"
                                                   class="markread">Mark as unread</a>
