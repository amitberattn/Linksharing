                ...
                <div class="entry-content">
                    ...
                    <span class="entry-date">
                        ...
                        %{--<a href="#">View post</a>--}%
                            ...
                            <g:if test="${resourceItem.createdBy.id == userDetail.id}">
                                <a href="#" id="edit">Edit</a>
                                <g:link style="cursor: pointer" controller="resource" action="deleteResource"
                                        id="${resourceItem.id}">Delete</g:link>
                            </g:if>
                        </div>
                    </span>
                </div>
