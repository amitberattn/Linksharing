<g:each in="${topicInstanceList}" var="topicInstance">
...
<div class="paginateButtons">
    <util:remotePaginate total="${topicInstanceTotal}" update="filteredList" controller="subscription" action="remotePagination" pageSizes="[5: '5 on Page',10:'10 on Page',15:'15 on Page']" prev="${"<<"}" next="${">>"}"/>
    %{--<util:remotePageScroll controller="subscription" action="remotePagination" max="3" total="${topicInstanceTotal}" update="commentsListId" class="btn-quaternary" />--}%
</div>