...
<div id="main-col">
    ...
    <div class="widget kopa-article-list-widget">
        <h3 class="widget-title"><span class="title-line"></span><span class="title-text">Forgot password</span></h3>
        ...
        <div class="tab-container-1">
            <g:form controller="userLogin" action="forgotPasswordEmailSet">
                ...
                <g:submitButton name="Send mail" value="Send mail"></g:submitButton>
            </g:form>
